...
public interface InputStrategy {
    ...
    abstract public char inputChar() throws ImproperUseException;

    abstract public char inputChar(final String message) throws ImproperUseException;

    abstract public char inputChar(final String message, final String header) throws ImproperUseException;
